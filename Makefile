...
tag-qa:
	...
	@cp assets/runtime/tag/coupon-v1.png assets/runtime/tag/investment-v1.png assets/runtime/tag/handy-v1.png assets/runtime/tag/economy-v1.png assets/runtime/tag/mega-v1.png "$(BUILD_DIR)/tag-qa/assets/runtime/tag/"
