...
function M.run()
    ...
    for index, name in ipairs(CARD_NAMES) do
        ...
        assert_region(cell.runtimeRegion, (index - 1) * 24, 24, 36, name .. " runtime")
        assert(cell.alphaBounds and cell.alphaBounds[1] == 0 and cell.alphaBounds[2] == 0
            and cell.alphaBounds[3] == 23 and cell.alphaBounds[4] == 35,
            name .. " alpha bounds must cover its 24x36 runtime cell")
    end
