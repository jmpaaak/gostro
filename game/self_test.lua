...
function M.run()
    ...
    require("game.tests.plaques").run()
    require("game.tests.tags").run()
    require("game.tests.boss_blinds").run()
    require("game.tests.seals").run()
    require("game.tests.vouchers").run()
    require("game.tests.wish_cards").run()
    require("game.tests.talismans").run()
    require("game.tests.talisman_migration").run()
    ...
    require("game.tests.talisman_target_ui").run()
    require("game.tests.talisman_use_flow").run()
