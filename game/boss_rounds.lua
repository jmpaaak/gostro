-- Final-round debuffs mapped onto hwatu play kinds.
...
-- Eight final rounds. Kind-targeted ones hit hongdan/cheongdan/chodan/godori/pi.
M.POOL = {
...
--- The Wall: double the round target.
